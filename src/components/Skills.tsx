...
import godotLogo from '/src/assets/godot_logo.png'

function Skills() {
    return (
        <div className="flex-container">
            <div><Cell imageCell={cppLogo} glowColor="#306998" /> </div>
            <div><Cell imageCell={pythonLogo} glowColor="#306998" /></div>
            <div><Cell imageCell={htmlLogo} glowColor="#E44D26" /> </div>
            <div><Cell imageCell={gitLogo} glowColor="#ca4429" /> </div>
            <div><Cell imageCell={godotLogo} glowColor="#306998" /></div>
        </div>
    );
}
